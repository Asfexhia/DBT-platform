...
import Signup from './compnents/SignupIn/Signup.jsx';
import Login from './compnents/login/Login.jsx';
import NoAccess from './compnents/noAccess/NoAccess.jsx';
import ProfileUpdate from './compnents/profile/ProfileUpdate.jsx';
import AnonymousSharing from './compnents/anonymous/AnonymousSharing.jsx';
import AnonymousPost from './compnents/anonymous/AnonymousPost.jsx';
import AllAnonymousPost from './compnents/anonymous/AllAnonymousPost.jsx';
...
function AppRoutes() {
  ...
  useEffect(() => {
    ...
    if (needs === '1') {
      const fromTherapist = prev.includes('/therapist');
